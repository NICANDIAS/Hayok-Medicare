...
@section('content')
<body class="gray-bg" style="background-image: url(img/hayok-medicare.jpg); background-size: cover;" data-ng-app="flicksApps" data-ng-controller="flicksAuthController">
    <div class="container">
